...
const STEPS: {
...
}[] = [
  {
    ...
    body: "Send the export you already produce — vAuto, HomeNet, Dealer.com, DealerSocket, CSV or XML. That's the whole setup: no new software, no IT project, nothing for your team to maintain.",
    tag: "Your only lift",
    tone: "cyan",
    meta: "~5 min, one time",
  },
  {
    n: "02",
    icon: "radar",
    title: "We rebuild every VIN as an AI-readable page",
    body: "Your current VDPs are built for human eyes — JavaScript-heavy, slow, and invisible to AI crawlers. LotPilot publishes a machine-readable twin for every car (schema.org Vehicle JSON-LD, clean semantic HTML, an llms.txt manifest, live-synced to your feed), then runs thousands of real buyer queries across every engine and tunes until your cars are the cited answer.",
    tag: "Get found by AI",
    tone: "accent",
    meta: "Auto-published + continuously tested",
  },
  {
    n: "03",
    icon: "messages",
    title: "A custom AI agent works every lead",
    body: "The moment a lead lands, your agent answers over SMS and voice, qualifies them — budget, trade, timeline, financing — captures the credit app, books the appointment, and hands your team only sale-ready buyers. 24/7, in seconds.",
    tag: "Win the lead",
    tone: "violet",
