        ...
        <div className="mt-10 overflow-hidden rounded-2xl border border-line bg-canvas-2 p-6 sm:p-8">
          <div className="grid items-center gap-6 sm:grid-cols-[1fr_auto_1fr]">
            <div className="text-center sm:text-right">
              <p className="text-xs uppercase tracking-wider text-ink-faint">A real shopper, today</p>
            ...
            <div className="text-center sm:text-left">
              <p className="text-xs uppercase tracking-wider text-ink-faint">What the AI answers</p>
              <p className="mt-2 text-sm text-ink-soft">
                <span className="rounded bg-danger/15 px-1.5 py-0.5 text-danger">Carvana</span>,{" "}
                <span className="rounded bg-danger/15 px-1.5 py-0.5 text-danger">CarGurus</span>, and a
                competing dealer.{" "}
