...
import { LEADS, type Lead, type LeadTemp } from "@/lib/dashboard/data";
                  ...
                  <div className="max-w-[78%]">
                    <div
                      className={cn(
                        ...
                        m.from === "buyer" && "rounded-tl-sm border border-line bg-white/[0.04] text-ink-soft",
                        m.from === "agent" && "rounded-tr-sm border border-cyan/30 bg-cyan/[0.08] text-ink",
                        m.from === "rep" && "rounded-tr-sm border border-violet/30 bg-violet/[0.12] text-ink",
                      )}
                    >
                      {m.text}
                    </div>
                    ...
                    >
                      {m.from === "agent" ? "AI agent" : m.from === "rep" ? "You" : active.name.split(" ")[0]} · {m.time}
                    </p>
                  </div>
                </div>
              );
